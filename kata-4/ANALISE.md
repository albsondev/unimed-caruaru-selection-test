...
Adotei as seguintes decisoes para garantir consistencia e previsibilidade do pipeline:
...
Eu preferi rejeitar silenciosamente o minimo possivel. Sempre que um registro e descartado, o pipeline registra a razao em um arquivo de qualidade de dados para manter rastreabilidade.
...
Se o pipeline fosse diario e critico para o negocio, eu tambem incluiria orquestracao, controle de versao dos schemas e testes de qualidade de dados no estilo contract testing.

## 4. Testes que eu escreveria

Os testes mais importantes para a qualidade das transformacoes seriam:
